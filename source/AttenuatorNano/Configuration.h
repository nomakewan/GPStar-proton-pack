 ...
 */
const bool b_enable_buzzer = false; // Enable/disable all buzzing via the local piezo buzzer
const bool b_enable_vibration = false; // Enable/disable all effects via the vibration motor
const bool b_overheat_feedback = false; // Enable/disable buzzing/vibration on pack overheat
